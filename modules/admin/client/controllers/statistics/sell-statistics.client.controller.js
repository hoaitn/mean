(function() {
    ...
    angular
        .module('admin')
        .controller('SellStatisticsController', InvoiceStatisticsController);
    ...
    function InvoiceStatisticsController($scope, $window, AdminStatisticsService) {
        ...
        function loadData() {
            AdminStatisticsService.filterSell().then(function(res) {
