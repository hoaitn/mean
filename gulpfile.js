...
neat.with('public/lib/bourbon/app/assets/stylesheets');
...
gulp.task('uglify:third', function() {

    var thirdAssets = _.union(
        defaultAssets.client.lib.js
    );

    return gulp.src(thirdAssets)
        .pipe(plugins.ngAnnotate())
        .pipe(plugins.uglify({
            mangle: false
        }))
...
gulp.task('build', function(done) {
    runSequence('env:dev', 'lint', ['uglify', 'uglify:third', 'cssmin'], done);
});
